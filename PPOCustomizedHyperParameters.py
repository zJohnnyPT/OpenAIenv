...
models_dir = "models/PPOCustomizedHyperParameters"
logdir = "logsdir"
...
# Create the PPO agent with customized hyperparameters
model = PPO(
    "MlpPolicy",
    env, 
    n_steps=1024, 
...
for i in range(301): # Train the agent for 300 episodes
    model.learn(total_timesteps=total_timesteps, reset_num_timesteps=False, tb_log_name="PPOCustomizedHyperParameters") # Train the agent for 10000 timesteps
