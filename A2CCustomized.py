...
models_dir = "models/A2CCustomized"
logdir = "logsdir"
...
for i in range(301): # Train the agent for 300 episodes
    model.learn(total_timesteps=total_timesteps, reset_num_timesteps=False, tb_log_name="A2CCustomized") # Train the agent for 10000 timesteps
